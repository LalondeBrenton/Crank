...
namespace Crank
{
	...
	void DX11ImGuiLayer::OnAttach()
	{
		...
		DX11Context* context = static_cast<DX11Context*>(Application::Get().GetRenderAPI()->GetContext().get());
	...
	void DX11ImGuiLayer::OnDetach()
	{
		...
		Application::Get().GetWindow()->ImGuiShutdown();
	...
	void DX11ImGuiLayer::Begin()
	{
		...
		Application::Get().GetWindow()->ImGuiNewFrame();
		ImGui::NewFrame();
	...
	void DX11ImGuiLayer::SetDarkThemeColors()
	{
